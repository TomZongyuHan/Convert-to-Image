...
processDataset("baron-mouse-RawCount.csv", TRUE)
processDataset("deng-reads-RawCount.csv", FALSE)
processDataset("manno_human-RawCount.csv", TRUE)
processDataset("manno_mouse-RawCount.csv", TRUE)
processDataset("TabulaMuris_Heart_10X-RawCount.csv", TRUE)
processDataset("TabulaMuris_Heart_FACS-RawCount.csv", TRUE)
